...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [KL_QWERTY] = LAYOUT_alice(
        ...
        /**/           KC_LSFT , KC_Z    , KC_X    , KC_C    , KC_V    , KC_B    , KC_B    , KC_N    , KC_M    , KC_COMM , KC_DOT  , KC_SLSH , KC_RSFT , MO_L    ,
    ...
    [KL_LOWER] = LAYOUT_alice(
        ...
        /**/ ________, ________, KC_HOME , ________, KC_END  , KC_PGUP , ________, ________, ________, ________, ________, ________, ________, ________, ________,
        /**/ ________, ________, ________, ________, ________, KC_PGDN , ________, KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT , ________, ________,           ________,
        /**/           ________, ________, ________, ________, ________, ________, KC_VOLD , KC_VOLU , KC_MUTE , KC_MPRV , KC_MNXT , KC_MPLY , ________, ________,
