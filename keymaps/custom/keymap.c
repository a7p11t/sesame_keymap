...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_alice(
        ...
        /**/ ________, ________, KC_HOME , KC_UP   , KC_END  , KC_PGUP , ________, ________, ________, ________, ________, ________, ________, ________, ________,
        /**/ ________, KC_CAPS , KC_LEFT , KC_DOWN , KC_RGHT , KC_PGDN , ________, ________, ________, ________, ________, ________, ________,           ________,
